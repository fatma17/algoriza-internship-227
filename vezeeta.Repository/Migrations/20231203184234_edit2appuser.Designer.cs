...
namespace vezeeta.Repository.Migrations
{
    ...
    [Migration("20231203184234_edit2appuser")]
    partial class edit2appuser
    {
            ...
            modelBuilder.Entity("Vezeeta.Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountType = "Admin",
                            ConcurrencyStamp = "770c2b2f-963e-4033-9383-d27f3b7fb8de",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEaL4hVltjunHnesl+9egG5w1ThwF4ukmnWpIz1AJOzEPQqd3/r9LCFA+P8Op7WT1A==",
